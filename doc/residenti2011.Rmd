...
```{r plot1, fig.width= 9, echo=FALSE, fig.height= 10 }
library (ggplot2)
...
```{r plot3, fig.width= 9, echo=FALSE,warning=FALSE}
library (plyr)
...
```{r plot5, fig.width= 8, echo=FALSE}
...
```{r plot7, fig.width= 6, echo=FALSE, fig.height=4}
DTtot3 <- DTtot
...
```{r plot8, fig.width= 9, echo=FALSE}
DT3 <- DT
...
```{r plot9, fig.width= 9, echo=FALSE}
...
```{r plot10, fig.width= 9, echo=FALSE}
